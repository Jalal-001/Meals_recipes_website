<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Kateqoriyalar.aspx.cs" Inherits="Cooking_website.Kateqoriyalar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ItemTemplate>
        <table class="auto-style1">
            <tr>
                <td><a href="Comments.aspx?Meal_ID=<%#Eval("Meal_Id") %>"><strong>Yeməyin adı:</strong><asp:Label ID="Label9" runat="server" Text='<%# Eval("Meal_Name") %>'></asp:Label>
                    </a></td>
            </tr>
            <tr>
